...
while true; do
  ...
  case "$choice" in
    ...
    3) openclaw gateway restart || openclaw gateway start ;;
    4) openclaw gateway restart || openclaw gateway start; miloco-cli service restart || miloco-cli service start ;;

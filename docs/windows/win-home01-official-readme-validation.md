# WIN-home01 官方 README 特性验收

- 目标机：`WIN-home01 / <tailscale-ip>`
- 验证方式：`Computer Use plugin -> 网易 UU 远程 -> WIN-home01`
...
| 特性 | 结果 | 证据 | 备注 |
|---|---|---|---|
| 通用常识 | 只做了只读替代验证 | Miloco 概览页能看到主卧实时画面卡片，可直接观察画面内容 | 未人为制造危险场景 |
...
- Miloco 概览页确认到至少 1 个 live camera 画面：`主卧 电脑桌上 · 主卧`。
